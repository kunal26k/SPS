...
// file in design/ → route. About is hand-built in src/app/about.
export const screens = [
  { file: "Home.html", route: "/", group: "Website", label: "Home" },
  { file: "Academics.html", route: "/academics", group: "Website", label: "Academics" },
  { file: "Admissions.html", route: "/admissions", group: "Website", label: "Admissions" },
...
for (const s of screens) {
  ...
  const id = s.route === "/" ? "home" : s.route.slice(1).replaceAll("/", "--");
  writeFileSync(
    join(outDir, `${id}.ts`),
